...
offer_ _a
[pre-built binary](https://github.com/zeitgeistpm/zeitgeist/releases/download/v0.2.4/zeitgeist_parachain)._
...
```bash
curl -o zeitgeist https://github.com/zeitgeistpm/zeitgeist/releases/download/v0.2.4/zeitgeist_parachain
chmod +x zeitgeist
```
